			...
			<div class="col-3 mb-3">
				<div class="card text-center" style="width: 18rem;">
					...
					<div class="card-body">
						...
						<a href="/NikaShop/admin/product/show?id=${ p.id }" class="btn btn-success w-100">Chi tiết</a>
					</div>
				</div>
			</div>
		</c:forEach>
		...
		<ul class="pagination">
			...
			<c:if test="${ currentPage > 1 }">
				<li class="page-item"><a class="page-link"
					href="/NikaShop/Home?page=${ currentPage - 1 }">Previous</a></li>
			</c:if>
			<c:forEach varStatus="i" begin="1" end="${ maxPage }">

				<li class="page-item  ${ currentPage == i.index ? 'active':'' }">
					<a href="/NikaShop/Home?page=${ i.index }" class="page-link">${ i.index }</a>
				</li>
			</c:forEach>
			...
			<c:if test="${ currentPage < maxPage }">
				<li class="page-item"><a class="page-link"
					href="/NikaShop/Home?page=${ currentPage + 1 }">Next</a></li>
			</c:if>
		</ul>
	</nav>
